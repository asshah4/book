...
This model can be visualized as well if we group each individual by their predicted values, based on the individual cosinor mesor, amplitude, and acrophase.

```{r}
model <- data.frame(xmat)
